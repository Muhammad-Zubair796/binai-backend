...
# This will show up immediately when the server starts
print("DEBUG: SERVER SCRIPT STARTED", flush=True)
...
print(f"DEBUG: Loaded {len(google_keys)} Google Keys", flush=True)
...
async def ask_vision(image: UploadFile = File(...), question: str = Form(...)):
    print(f"DEBUG: Request received at /ask-vision. Question: {question}", flush=True)
    ...
    try:
        ...
        print(f"DEBUG: ERROR in /ask-vision: {str(e)}", flush=True)
        return {"status": "error", "message": "Connection lost. Please contact Zubair for support."}

@app.post("/navigate")
async def navigate(image: UploadFile = File(...)):
    print("DEBUG: Request received at /navigate", flush=True)
    ...
    try:
        ...
        print(f"DEBUG: ERROR in /navigate: {str(e)}", flush=True)
        return {"status": "error", "message": "Connection lost. Please contact Zubair for support."}
